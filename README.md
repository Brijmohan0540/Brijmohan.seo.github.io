...
## How to update this website later

If you need to update the portfolio in the future, follow this simple rule:

- **Text/content updates:** edit `index.html`
- **Design/color/layout updates:** edit `styles.css`
- **Footer year behavior:** edit `script.js`
- **Search engine setup:** edit `robots.txt` and `sitemap.xml`

### Most common updates

#### Update your name, title, or hero text
Open `index.html` and edit the top hero section text.

#### Update services
Search for the **Services** section in `index.html` and change the card titles and descriptions.

#### Update case studies
Search for the **Case Studies** section in `index.html` and replace the sample numbers with your real SEO results.

#### Update contact details
Search for `yourname@example.com` in `index.html` and replace it with your real email, LinkedIn, and GitHub links.

#### Update colors or style
Open `styles.css` and edit the variables at the top such as `--brand`, `--brand-strong`, and `--bg`.

### After making updates
Save the files, then upload them again to GitHub or run:
